...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PA0-CK_IN     ------> ADC_IN0
    */
    GPIO_InitStruct.Pin = Breath_Sensor_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(Breath_Sensor_ADC_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA0-CK_IN     ------> ADC_IN0
    */
    HAL_GPIO_DeInit(Breath_Sensor_ADC_GPIO_Port, Breath_Sensor_ADC_Pin);
